...
int main (void)
{
   ...
   fclose(bin);
   getch();// para hacer una pausa

   return 0;

/*   hacer un menu de alta (escribir) baja modificar y salir agregar isEmpty 0 de alta de baja ponerlo en 1
    listar todos (como lo veniamos haciendo (primero hacer un listar uno))
*/
}
